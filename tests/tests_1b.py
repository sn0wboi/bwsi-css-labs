...
def test_addition():
    ...
    assert simple_calculator("add", -4, -1) == -5       # test for double negative
...
def test_subtraction():
    ...
    assert simple_calculator("subtract", 5, -3) == 8    # test for addition by subtraction if that makes sense
...
def test_multiplication():
    ...
    assert simple_calculator("multiply", -2, -2) == 4  #test for 2 negatives
